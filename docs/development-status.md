...
编译器：GCC 16.1.1
常规 CTest：19/19 PASS
ASan/UBSan：19/19 PASS
TSan（多通道/重载/输入恢复相关）：4/4 PASS
...
1. 增加 MediaMTX 发布端中断与恢复测试。
2. 明确 Phase 3 开发机验收完成项，并整理 RK3588 实机验收清单。
3. 在 RK3588 上执行真实 RTSP 输入断开、恢复和重新发布验收。
